...
SpellInfo = {
  ['Default'] = {
	...
	['Frigo'] =                    {id = 998, words = 'frigo',           	   exhaustion = 2000,  premium = false, type = 'instant', icon = 'icicle',                 mana = 1,      level = 28, soul = 0, group = {[3] = 2000},               	vocations = {2, 6}},
	['tornado'] =             	   {id = 999, words = 'tornado',               exhaustion = 0,     premium = false, type = 'instant', icon = 'holymissile',            mana = 1,    level = 1, soul = 3, group = {[3] = 0},                     vocations = {2, 6}}
